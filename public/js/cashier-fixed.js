            ...
            <div class="d-flex justify-content-between align-items-center mb-2 p-2 border rounded">
                ...
                <div class="text-end">
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-outline-secondary" onclick="window.updateQuantity(${index}, -1)">-</button>
...
// Fonction de finalisation de vente
    ...
    products.forEach(product => {
        html += `
            <div class="col-md-6 col-lg-4 mb-3 product-item"
                ...
                <div class="card h-100 product-card" onclick="window.addToCart(${product.id})">
...
// Fonction de scan de code-barres
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('searchInput').addEventListener('input', window.searchProducts);
    document.getElementById('categoryFilter').addEventListener('change', window.searchProducts);
    document.getElementById('supplierFilter').addEventListener('change', window.searchProducts);
