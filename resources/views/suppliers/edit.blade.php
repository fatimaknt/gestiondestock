                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h1 class="h2 fw-bold text-dark mb-1 mt-2">Modifier le fournisseur</h1>
                            <p class="text-muted mb-0">Modifiez les informations de "{{ $supplier->name }}"</p>
                        </div>
                        <div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="3"
                                            placeholder="Ex: 123 Rue de la Paix, Dakar, Sénégal" required>{{ old('address', $supplier->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="3"
                                            placeholder="Informations supplémentaires, conditions spéciales, etc.">{{ old('notes', $supplier->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
